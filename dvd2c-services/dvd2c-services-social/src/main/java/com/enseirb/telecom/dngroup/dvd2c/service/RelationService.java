...
public interface RelationService {
	 ...
	 * 
	 * @param userUUIDToGet
	 *            the first user to get content
	 * @param userUUIDForm
	 *            the second user
	 * @return a list of content
	 */
	public abstract List<Content> getAllContent(UUID userUUIDToGet,
			UUID userUUIDForm);

	/**
	 * create a relation between userUUID and the relation and send a request to
	 * create the relation on the other box
	 * 
	 * @param userUUID
	 *            of the box
	 * @param relationUUID
	 *            the second user
	 * @param fromBox
	 *            if the request is from the box
	 * @return the relation
	...
	/**
	 * update a relation between the user this service verify the status
	 * 
	 * @param userUUID
	 *            of the box
	 * @param relation
	 ...
	 * @throws NoRelationException
	 */
	public abstract void deleteRelation(UUID userUUID, UUID relationUUID)
	 ...
	 * 
	 * @param userUUID
	 *            the relation to update metaData
	 * @throws IOException
	 *             if the request have a problem
	 * @throws NoSuchUserException
	 ...
	 * @throws NoRelationException
	 */
	public abstract void deleteRelationBox(UUID userUUID, UUID relationUUID)
			throws NoRelationException;

	/**
	 * Generate Role for relation (it make this classe only one time)
	 * 
	 * @param fromString
	 */
	...
	/**
	 * Add right for roles of one video
	 * 
	 * @param content
	 *            to add roles
	 */
	public abstract void setContentRole(Content content);

	public abstract List<ActivityObjectExtand> getActivityForContact(UUID actorUUID, UUID contactUUID);
