				...
				[
						...
						function($http, $location) {
													...
													if (json.user.PropertyGroups != undefined) {
														...
														if (user.smtp
																...
																&& user.smtp
																		.hasOwnProperty("host")
																&& user.smtp.host != ""
																&& user.smtp.host != undefined
																&& user.smtp
																		.hasOwnProperty("port")
																&& user.smtp.port != ""
																&& user.smtp.port != undefined
																&& user.smtp
																		.hasOwnProperty("password")
																&& user.smtp.password != ""
																&& user.smtp.password != undefined) {
															...
															console
																...
																.hasOwnProperty("google")
																&& user.smtp.google != ""
																&& user.smtp.google != undefined) {
															user.smtpTab = 2;
															console
																	.log("view 2");
														} else if (user.smtp
																.hasOwnProperty("yahoo")
																&& user.smtp.yahoo != ""
																&& user.smtp.yahoo != undefined) {
															user.smtpTab = 3;
															console
																	.log("view 3");
														} else if (user.smtp
																.hasOwnProperty("microsoft")
																&& user.smtp.microsoft != ""
																&& user.smtp.microsoft != undefined) {
															user.smtpTab = 4;
															console
																	.log("view 4");
														} else {
							...
							this.putSmtp = function(smtp) {
								...
								if (smtp.host != "")
									data.propertyGroups.property.push({
										key : "host",
										value : smtp.host
									});
								if (smtp.port != "")
								...
								$http
										...
										.error(
												function(data, status, headers,
														config) {
													console
															.log("Failed while editing SMTP settings");
													user.class = "btn-danger";
												});
							}
