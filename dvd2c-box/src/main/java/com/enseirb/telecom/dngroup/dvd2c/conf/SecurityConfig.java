...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests()
				.antMatchers("/api/application.wadl", "/api/app/register/")
				.permitAll().antMatchers("/api/box/**").permitAll()
				.antMatchers("/api/snapmail/**").permitAll()
				.antMatchers("/api/app/content/**").permitAll()
				.antMatchers("/api/app/content/unsecure/**")
				.permitAll()
				.anyRequest()
				.authenticated()
				.and()
