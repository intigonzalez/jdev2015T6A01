...
public class ThreadRestServer extends Thread{
	...
	private static void startGrizzlyServer() throws IOException, InterruptedException {
		try {
			...
			webappContext
					.addContextInitParameter(
							...
							com.enseirb.telecom.dngroup.snapmail.conf.SpringConfiguration.class
									.getName());
			...
			jerseyServlet
					.setInitParameter(
							...
							com.enseirb.telecom.dngroup.snapmail.conf.RestConfiguration.class
									.getName());
